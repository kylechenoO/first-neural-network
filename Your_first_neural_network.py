...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.activation_function_pre = lambda x : self.activation_function(x) * (1 - self.activation_function(x))
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            hidden_error_term = hidden_error * self.activation_function_pre(hidden_inputs)
